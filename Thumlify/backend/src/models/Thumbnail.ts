...
export interface IThumbnail extends Document {
    ...
    color_schema?: "vibrant" | "sunset" | "forest" | "neon" | "purple" | "monochrome" | "ocean" | "pastel";
...
const ThumbnailSchema = new mongoose.Schema<IThumbnail>(
    ...
    color_schema:{type:String, required:true, enum:["vibrant" , "sunset" , "forest" , "neon" , "purple" , "monochrome" , "ocean" , "pastel"]}, 
